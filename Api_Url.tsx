...
export const createAdmin = async (data: CreateAdminRequest): Promise<DataResponse> => {
  try {
    const response = await axios.post<DataResponse>(
      `${API_BASE_URL}SEMS/Admin/CreateAdmin`, data, 
...
export const getAdminById = async (id: number): Promise<AdminResponse> => {
  try {
    const response = await axios.get<AdminResponse>(
      `${API_BASE_URL}SEMS/Admin/GetAdminById${id}`, 
      { headers: { "Accept": "*/*" } }
    );
    return response.data;
  } catch (error) {
...
export const updateAdmin = async (data: AdminData): Promise<DataResponse> => {
  try {
    const response = await axios.put<DataResponse>(
      `${API_BASE_URL}SEMS/Admin/UpdateAdmin`, data, 
      { headers: { "Content-Type": "application/json" } }
    );
    return response.data;
  } catch (error) {
...
export const createCustomer = async (data: CreateAdminRequest): Promise<DataResponse> => {
  try {
    const response = await axios.post<DataResponse>(
      `${API_BASE_URL}SEMS/Customer/CreateCustomer`, data, 
      { headers: { "Content-Type": "application/json" } }
    );
    return response.data;
  } catch (error) {
...
export const getCustomerById = async (id: number): Promise<CustomerResponse> => {
  try {
    const response = await axios.get<CustomerResponse>(
      `${API_BASE_URL}SEMS/Customer/GetCustomerById${id}`, 
      { headers: { "Accept": "*/*" } }
    );
    return response.data;
  } catch (error) {
...
export const getAllCustomers = async (): Promise<CustomerResponse[]> => {
  try {
    const response = await axios.get<CustomerResponse[]>(
      `${API_BASE_URL}SEMS/Customer/GetAllCustomers`,
      { headers: { "Accept": "*/*" } }
    );
    return response.data;
  } catch (error) {
...
export const createMeter = async (adminUserId: number): Promise<DataResponse> => {
  try {
    const response = await axios.post<DataResponse>(
      `${API_BASE_URL}SEMS/Meter/CreateMeter`, { adminUserId, isActive: false },
      { headers: { "Content-Type": "application/json" } }
    );
    return response.data;
  } catch (error) {
...
export const attachMeterToCustomer = async (meterId: string, meterKey: string, userId: number): Promise<DataResponse> => {
  try {
...
export const updatePrices = async (data: PriceUpdateDto): Promise<DataResponse> => {
  try {
    const response = await axios.put<DataResponse>(
      `${API_BASE_URL}SEMS/Prices/UpdatePrices`, data, 
      { headers: { "Content-Type": "application/json" } }
    );
    return response.data;
  } catch (error) {
...
export const checkUserName = async (username: string): Promise<boolean> => {
  try {
    const response = await axios.get<boolean>(
      `${API_BASE_URL}SEMS/User/CheckUserName?username=${username}`
    );
    return response.data;
  } catch (error) {
